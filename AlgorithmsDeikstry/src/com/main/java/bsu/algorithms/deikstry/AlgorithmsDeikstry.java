package com.main.java.bsu.algorithms.deikstry;
...
public class AlgorithmsDeikstry {
    private static int INF = Integer.MAX_VALUE / 2;

    private int n; //количество вершин в орграфе
    private int m; //количествое ребер в орграфе
    ...
    private void deikstra(int s) throws IOException {
        ...
        for (int iter = 0; iter < n; ++iter) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                v = i;
                distV = dist[i];
            } //рассматриваем все ребра, исходящие из найденной вершины
    ...
    private void readData() throws IOException {
        ...
        start = Integer.parseInt(tokenizer.nextToken()) - 1; //инициализируем списка смежности графа размерности n
        adj = new ArrayList[n];
        for (int i = 0; i < n; ++i) {
            adj[i] = new ArrayList();
        }
...
//считываем граф, заданный списком ребер
    ...
    public static void main(String[] args) throws IOException {
        AlgorithmsDeikstry algorithmsDeikstry = new AlgorithmsDeikstry();
        algorithmsDeikstry.run();
    }
}
