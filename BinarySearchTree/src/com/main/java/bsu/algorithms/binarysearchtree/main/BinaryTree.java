...
public class BinaryTree {
    ...
    public TreeNode searchParent(int number, TreeNode root){
        ...
        if (root.getNumber() < number) {
            ...
            return searchParent(number, root.getLeft());
        }
    }
    ...
    public void rotationLeft(TreeNode node){
        ...
        if (node.getRight() != null){
            ...
            node.setCountNodeRight(node.getLeft().getCountNodeRight());//количество потомков справа, я правую чатсь не трогали значит не меняю
    ...
    public void rotationRight(TreeNode node){
        ...
        if (node.getLeft() != null){
            ...
            node.setCountNodeLeft(node.getLeft().getCountNodeLeft());
        ...
        if (root != null) {
            if (root.getNumber() == number) {
                if (root.getRight() != null && root.getLeft() == null) {
                    ...
                    if (root.getLeft() != null && root.getRight() == null) {//analogy
