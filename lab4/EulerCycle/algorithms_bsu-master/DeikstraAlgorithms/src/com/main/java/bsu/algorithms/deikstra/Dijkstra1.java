package com.main.java.bsu.algorithms.deikstra;
...
public class Dijkstra1 {
    ...
    public static void dijkstra(Graph g, int s, long[] prio) {
        try{
...
// begin
    ...
    public static void ReadFile() {
        try{
            RandomAccessFile f = new RandomAccessFile("src/com/main/java/bsu/algorithms/deikstra/graph.txt", "r"); //файл с матрицей
            String s;
...
//        dijkstra(g, 0, path, pred);
        dijkstra(g, 0, path);
for(int i=0;i<6;i++) {
    System.out.println("Shortest path: " + path[i]);
}
        System.gc(); }
}